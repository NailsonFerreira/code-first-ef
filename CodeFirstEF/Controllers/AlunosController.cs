...
namespace CodeFirstEF.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AlunoID,Nome,Cpf,Email,CursoID")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AlunoID,Nome,Cpf,Email,CursoID")] Aluno aluno)
        {
            if (ModelState.IsValid)
            {
